...
This repo contains visualizations for different aspects of the following datasets.

[Canadian immigration data from 1980 to 2013](https://www.un.org/en/development/desa/population/migration/data/empirical2/migrationflows.asp#)  

[US domestic flights between 1987 and 2020](https://developer.ibm.com/exchanges/data/all/airline/?utm_medium=Exinfluencer&utm_source=Exinfluencer&utm_content=000026UJ&utm_term=10006555&utm_id=NA-SkillsNetwork-Channel-SkillsNetworkCoursesIBMDeveloperSkillsNetworkDV0101ENSkillsNetwork20297740-2021-01-01)

## Visualization techniques

### Pandas, Matplotlib, Seaborn, Word Cloud 
